...
const DashboardPage = ({ actionId, isSidebarOpen }) => {
    const [selectedPanel, setSelectedPanel] = (0, react_1.useState)(1);
    if (!actionId) {
        return (<div className={`dashboard-container ${isSidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
      ...
      <div className="dashboard-main">
        ...
        <div className="dashboard-content">
          ...
          <div className="panel-selector">
            {[1, 2, 3, 4].map((panelNum) => (<button key={panelNum} className={`panel-btn ${selectedPanel === panelNum ? 'active' : ''}`} onClick={() => setSelectedPanel(panelNum)}>
                Panel {panelNum}
              </button>))}
          </div>
          ...
          <div className="panel-content">
            {selectedPanel === 1 && (<div className="panel-section">
            ...
            {selectedPanel === 2 && (<div className="panel-section">
            ...
            {selectedPanel === 3 && (<div className="panel-section">
            ...
            {selectedPanel === 4 && (<div className="panel-section">
