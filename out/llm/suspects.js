...
exports.extractSuspects = extractSuspects;
/**
 ...
 */
function extractSuspects(logText, opts) {
...
function makeExcerpt(lines, centerIndex, padding) {
...
function isGeneratedOrVendor(path) {
    ...
    return (/(^|\/)(dist|out|build|coverage|vendor|node_modules)(\/|$)/.test(path) ||
